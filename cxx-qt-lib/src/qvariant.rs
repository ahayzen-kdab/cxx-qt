...
extern "C" {
    ...
    fn qvariant_get_type(this: &QVariant) -> QVariantEnum;
...
impl Variant {
    ...
    // TODO: add a set_value(&mut self, value: VariantEnum);

    pub fn value(&self) -> VariantEnum {
        match unsafe { qvariant_get_type(&self.inner) } {
            QVariantEnum::Unsupported => VariantEnum::Unsupported,
            QVariantEnum::Bool => VariantEnum::Bool(unsafe { qvariant_to_bool(&self.inner) }),
            QVariantEnum::F32 => VariantEnum::F32(unsafe { qvariant_to_f32(&self.inner) }),
            QVariantEnum::F64 => VariantEnum::F64(unsafe { qvariant_to_f64(&self.inner) }),
            QVariantEnum::I8 => VariantEnum::I8(unsafe { qvariant_to_i8(&self.inner) }),
            QVariantEnum::I16 => VariantEnum::I16(unsafe { qvariant_to_i16(&self.inner) }),
            QVariantEnum::I32 => VariantEnum::I32(unsafe { qvariant_to_i32(&self.inner) }),
            QVariantEnum::String => {
                let mut s = String::new();
                unsafe { qvariant_copy_to_string(&self.inner, &mut s) };
                VariantEnum::String(s)
            }
            QVariantEnum::U8 => VariantEnum::U8(unsafe { qvariant_to_u8(&self.inner) }),
            QVariantEnum::U16 => VariantEnum::U16(unsafe { qvariant_to_u16(&self.inner) }),
            QVariantEnum::U32 => VariantEnum::U32(unsafe { qvariant_to_u32(&self.inner) }),
        }
    }
